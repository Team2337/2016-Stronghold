...
public class OI {
  ...
  //BUTTONS
    ...
    public OI() {
        ...
        SmartDashboard.putData("intake_ActivateMotors", new intake_ActivateMotors(1));
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        ...
        gripLed_On = new JoystickButton(operatorJoystick, 3);
        gripLed_On.whileHeld(new led_GRIPOn());
        
        gripLed_Off = new JoystickButton(operatorJoystick, 4);
